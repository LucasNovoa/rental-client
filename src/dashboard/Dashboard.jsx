...
const Dashboard = () => {
  const users = useFetch('https://rental-bookings-server.herokuapp.com/api/v1/users')
  const hotels = useFetch('https://rental-bookings-server.herokuapp.com/api/v1/hotels')
